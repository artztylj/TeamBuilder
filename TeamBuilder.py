...
def create_offensive_chart(team_df):
    ...
    if team_size == 6:
        d = {pokemmo_df.iloc[0].name: base_values,
             pokemmo_df.iloc[1].name: base_values,
             pokemmo_df.iloc[2].name: base_values,
             pokemmo_df.iloc[3].name: base_values,
             pokemmo_df.iloc[4].name: base_values,
             pokemmo_df.iloc[5].name: base_values,
...
def calc_defense(team_df):
    ...
    team_chart = create_defensive_chart(team_df)
    ...
    final_def_chart = tally_defense(team_chart, team_df)
...
pokemmo_team = ["Torterra", "Crobat", "Magnezone", "Umbreon", "Alakazam", "Kingdra"]
pokemmo_df = create_team_df(pokemmo_team)

offensive_chart = calc_offense(pokemmo_df)
defensive_chart = calc_defense(pokemmo_df)
